---
title: "Machine Learning Chapter 5 Lab"
author: "Yifan YE"
date: "10/30/2018"
...
First use: Estimating the Accuracy of a Statistic of Interest
...
The Portfolio data set in the ISLR package is described in Section 5.2. To illustrate the use of the bootstrap on this data, we must first create a function, alpha.fn(), which takes as input the (X, Y) data as well as a vector indicating which observations should be used to estimate $\alpha$ based on the selected observations.
```{r}
...
Second use: Estimating the Accuracy of a Linear Regression Model
